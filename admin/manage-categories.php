...
<?php if(isset($_SESSION['add-category-success'])) : // shows if add category was successfull ?>
    ...
    <div class="container dashboard__container">
        <button  type="button" id="show__sidebar-btn" class="sidebar__toggle"><i class="uil uil-angle-right-b"></i></button>
        <button type="button" id="hide__sidebar-btn"class="sidebar__toggle"><i class="uil uil-angle-left-b"></i></button>
        <aside>
            <ul>
                <li>
                    <a href="add-post.php">
